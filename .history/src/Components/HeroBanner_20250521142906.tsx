  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="relative max-w-[950px] mx-auto text-center pt-20 pb-28 sm:pb-20 banner-content">
          {/* Background red shape behind the text */}
          <div className="absolute inset-0 w-full h-full bg-[#E32E2E] mix-blend-multiply z-[-1] banner-content-bg" />

          {/* Play Button */}
          <motion.div
            className="btn-wrapper mb-6 sm:mb-8"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 1.5, duration: 0.5 }}
          >
            <button
              className="bg-white text-red-600 p-5 sm:p-6 rounded-full shadow-lg hover:scale-110 transition-transform duration-300"
          ...
          {/* Heading */}
          <motion.h1
            className="title text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight text-white"
          ...
          {/* Description */}
          <motion.p
            className="cf_text text-sm sm:text-base md:text-lg text-white max-w-xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* Tailwind CSS styles using @apply */}
      <style>{`
        .banner-content-bg {

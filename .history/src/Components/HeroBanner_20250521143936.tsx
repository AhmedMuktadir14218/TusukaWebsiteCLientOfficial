...
const HeroBanner: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      {/* Banner Content */}
      <div className="absolute inset-0 flex items-center w-full justify-center z-10 px-4 sm:px-8">
        <div className="relative max-w-[950px]  text-center pb-28 sm:pb-16">
          {/* Red Background Shape */}
         <div
  className="absolute inset-x-0 top-0 bottom-0 bg-[#E32E2E] -z-10 opacity-80"
  style={{
    mixBlendMode: 'multiply',
    borderRadius: window.innerWidth <= 767
      ? '0'
      : '0 100% 50% 50% / 0 0 100% 100%',
    minHeight: '80%', // ensures it covers more space
  }}
/>
          ...
          {/* Heading */}
          <motion.h2
            className="text-white font-bold text-3xl sm:text-4xl md:text-5xl leading-tight mb-4"
          ...
          {/* Paragraph */}
          <motion.p
            className="text-white max-w-2xl mx-auto text-base sm:text-lg"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}

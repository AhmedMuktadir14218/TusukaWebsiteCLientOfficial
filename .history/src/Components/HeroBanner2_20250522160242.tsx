      ...
      <div className="absolute inset-0 flex items-center justify-start z-10 px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <button
                className="bg-[#040270] text-white py-3 px-8 rounded-full shadow-lg hover:bg-opacity-90 transition-colors"
          ...
          >
            ...
            >
              ...
              {/* Main Button */}
              <div 
                className="relative z-10 bg-[#040270] opa text-white p-6 md:p-8 lg:p-10 rounded-full 

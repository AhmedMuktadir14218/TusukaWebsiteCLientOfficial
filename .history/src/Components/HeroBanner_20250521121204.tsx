...
const bannerImages = [
  '/src/assets/images/banner-1.jpg', // Replace with your image paths
  '/src/assets/images/banner-2.jpg',
  '/src/assets/images/banner-3.jpg',
];

const videoUrl = '/src/assets/videos/sample-video.mp4'; // Replace with your video path
    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/70 to-white/0 flex items-center justify-center p-4 sm:p-8 md:p-16">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <motion.div
            className="absolute bg-red-600 rounded-full flex items-center justify-center p-8 sm:p-12 md:p-20 lg:p-32"

    ...
    <section className="relative w-full py-20 overflow-hidden">
     ...
     <div style={{ width: '100%' }}>
       ...
       ></iframe>
        ...
        {/* Contact Info Box */}
       <div style="width: 100%"><iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src=><a href="https://www.gps.ie/collections/personal-trackers/">Personl trackers</a></iframe></div>
      </div>
    </section>
  );
};

...
const HeroBanner: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[85vh] overflow-hidden">
      ...
      {/* Banner Content Area */}
      <motion.div className="absolute inset-0 flex items-center justify-center z-10 px-4 sm:px-8">
        
        <motion.div
  className="absolute inset-x-0 top-1/2 -translate-y-1/2 bg-[#E32E2E] -z-10 opacity-60 brightness-100"
  ...
  style={{
    ...
    height:
      typeof window !== 'undefined' && window.innerWidth <= 767
        ? '50vh'
        : 'clamp(400px, 55vh, 600px)',
    width:
      typeof window !== 'undefined' && window.innerWidth <= 767
        ? '90vw'
        : 'clamp(500px, 80vw, 900px)',
    left: '50%',

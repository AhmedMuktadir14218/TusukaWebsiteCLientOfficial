    ...
    <section className="relative w-full py-20 overflow-hidden">
     ...
     <div style={{ width: '100%' }}>
       ...
       ></iframe>
        ...
        {/* Contact Info Box */}
         {/* Contact Info Box */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[450px] p-8 lg:p-12 bg-green-500 text-white shadow-xl flex flex-col justify-end items-start"
             style={{ minHeight: '380px' }}> {/* Added minHeight to better match the image aspect ratio */}
          <img src={Tusuka_Logo_tr} alt="Binox Logo" className="h-8 mb-6" /> {/* Assuming white logo version */}

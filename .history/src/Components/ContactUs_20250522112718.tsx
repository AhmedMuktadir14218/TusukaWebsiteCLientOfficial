...
import binoxLogoWhite from '../assets/binox-logo-white.png'; // Assuming you have a white version of the Binox logo for this section
        ...
        */}
        <div style={{ width: '100%', height: '100%' }}> {/* Ensure this div takes full height */}
          <iframe
            ...
            marginHeight={0}
            marginWidth={0}
            src="https://maps.google.com/maps?width=100%25&height=600&hl=en&q=Bangladesh+(Tusuka%20Group)&t=&z=14&ie=UTF8&iwloc=B&output=embed"
        ...
        <div
          className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-[calc(50%+150px)] md:-translate-x-[calc(50%+250px)] lg:-translate-x-[calc(50%+300px)] w-[90%] max-w-[450px] p-8 lg:p-12 bg-green-500 text-white shadow-xl flex flex-col justify-end items-start"
        ...
        >
          ...
          <img src={binoxLogoWhite} alt="Binox Logo" className="h-8 mb-6" />

    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10 px-4 sm:px-8">
        <div className="relative max-w-[950px] w-full text-center pb-28 sm:pb-16">
          ...
          {/* Heading */}
          <motion.h2
            className="text-[#FEF2ED] font-bold text-3xl sm:text-4xl md:text-5xl leading-tight mb-4"
          ...
          {/* Paragraph */}
          <motion.p
            className="text-[#FEF2ED] max-w-2xl mx-auto text-base sm:text-lg"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* Settings Icon */}
      <div className="fixed right-0 top-1/2 -translate-y-1/2 p-4 bg-gray-800 text-white rounded-l-lg shadow-lg z-40 cursor-pointer opacity-50">

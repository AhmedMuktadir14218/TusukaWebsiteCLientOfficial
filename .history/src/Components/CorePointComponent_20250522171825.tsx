...
import { LuArmchair, LuLeaf, LuBuilding2, LuFlaskConical, LuShieldCheck, LuHandshake } from 'react-icons/lu'; // Icons to represent the new services
            ...
            {points.map((service, index) => (
              ...
              >
                <div className="text-green-600 mb-4">
                  <service.icon className="h-10 w-10" /> {/* Dynamic icon */}
                </div>

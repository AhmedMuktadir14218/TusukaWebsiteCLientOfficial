...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  const navItems = [
    {
    label: <Link to="/" className="inline">Home</Link>,
    },
    {
      label: (
...
},
{
  label: <Link to="/mvc?tab=commitment" className="inline">Commitment</Link>,
    ...
    {
      label: <Link to="/eventsmedia" className="inline">Events & Media</Link>,
    },
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex-shrink-0"><Link to="/">
          <img src={logoimg} alt="Company Logo" className="h-10 w-auto" /></Link>
        </div>
...
//         { label: "Mission", link: "/mvc" },
//         { label: "Vision", link: "/mvc?tab=vision" },
//         { label: "Commitment", link: "/mvc?tab=commitment" },
...
//       subItems: [
//         { label: "Manufacturing Units", link: "/plants" },
//         { label: "Laundry Unit", link: "/plants?tab=laundry" },
//         { label: "Packaging Unit", link: "/plants?tab=packaging" },
//         { label: "Embroidery Unit", link: "/plants?tab=embroidery" },
//       ],
//     },
//     {
//       label: "Join With Us",

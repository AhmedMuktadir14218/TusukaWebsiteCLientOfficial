  ...
  return (
    ...
    <section className="relative w-full h-[85vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-start z-10 px-4 sm:px-8">
        <div className=" bg-gray-600 bg-opacity-25 p-9 rounded-2xl grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
          ...
          >
            {/* Heading */}
            <motion.h2
              className="text-white font-BeatriceTRIAL_bold disabled:opacity-75  text-3xl sm:text-4xl md:text-5xl leading-tight"

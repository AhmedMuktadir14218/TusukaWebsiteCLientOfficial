  ...
  return (
    ...
    <section className="relative w-full h-[85vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-start z-10 px-4 sm:px-8">
        <div className=" bg-gray-600 opacity-25 p-9 rounded-2xl grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
          ...
          >
            {/* Heading */}
            <motion.h2
              className="text-white font-BeatriceTRIAL_bold disabled:opacity-25  text-3xl sm:text-4xl md:text-5xl leading-tight"
            ...
            {/* Paragraph */}
            <motion.p
              className="text-gray-200 max-w-xl text-base font-medium disabled:opacity-25"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <button
                className="bg-[#040270] opacity-40 text-white disabled:opacity-25 py-3 px-8 rounded-full shadow-lg hover:bg-opacity-90 transition-colors"
          ...
          >
            ...
            >
              ...
              {/* Main Button */}
              <div 
                className="relative z-10 bg-[#040270] opacity-50 disabled:opacity-25 text-white p-6 md:p-8 lg:p-10 rounded-full 

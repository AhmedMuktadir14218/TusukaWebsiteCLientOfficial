        ...
        <div className="relative w-full">
          ...
          >
            <iframe
              ...
              marginHeight={0}
              marginWidth={0}
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.7834238295172!2d90.40111647602379!3d23.790725387225752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c70d8e9e0425%3A0x2f8397857b7b31e8!2sTusuka%20Group!5e0!3m2!1sen!2sbd!4v1747904600772!5m2!1sen!2sbd"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <motion.button
              ...
              className="  flex justify-center items-center py-3 px-4 rounded-lg bg-gradient-to-r from-[#955DF2] to-[#1E1E9C] text-white font-medium hover:opacity-90 transition duration-200 shadow-md"
                            >
              Submit Now →
            </motion.button>
          </motion.form>

...
const HeroBanner: React.FC = () => {
  ...
  // --- useEffect hook for automatic banner change ---
  useEffect(() => {
  ...
  return (
    <section className="relative w-full h-[85vh] overflow-hidden">
      ...
      <AnimatePresence>
        {isModalOpen && (
          <motion.div
            className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4 backdrop-blur-sm" // Changed here
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
      ...
      {/* The LogoMoving component is outside the HeroBanner section to appear below it */}

  ...
  return (
    <section className="relative w-full h-[85vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-end z-10 px-4 sm:px-8">
        <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg bg-white bg-opacity-90 rounded-lg p-6 md:p-8 lg:p-10 text-center mr-0 md:mr-16 lg:mr-24 shadow-lg"> {/* Added right margin */}

...
const HeroBanner: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      {/* Overlay with red half-circle shape and text */}
      <div className="absolute inset-0 bg-gradient-to-r from-white/70 to-white/0 flex items-center justify-center p-4 sm:p-8 md:p-16">
        <div className="relative w-full h-full flex items-center justify-center">
          {/* Red Half-Circle Shape with Curved Part on Top */}
          <motion.div
            className="absolute bg-red-600 flex items-center justify-center p-8 sm:p-12 md:p-20 lg:p-32"
            initial={{ scale: 0.5, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ type: "spring", stiffness: 100, damping: 10, delay: 0.5 }}
            style={{
              width: 'clamp(300px, 70vw, 800px)', // Responsive width
              height: 'clamp(300px, 70vw, 800px)', // Responsive height
              transform: 'translateY(20%)', // Move the circle down
              clipPath: 'circle(50% at 50% 0%)', // Half circle (top half)
            }}
          >

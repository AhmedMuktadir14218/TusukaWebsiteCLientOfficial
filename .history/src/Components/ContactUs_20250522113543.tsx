...
/>
        ...
        <div
          className="absolute top-1/2 -1/2 transform -translate-y-1/2 -translate-x-[calc(50%+150px)] md:-translate-x-[calc(50%+250px)] lg:-translate-x-[calc(50%+300px)] w-[90%] max-w-[450px] p-8 lg:p-12 bg-green-500 text-white shadow-xl flex flex-col justify-end items-start"

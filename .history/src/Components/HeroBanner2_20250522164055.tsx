  ...
  return (
    ...
    <section className="relative w-full h-[85vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-start z-10 px-4 sm:px-8">
        <div className=" bg-transparent bg-blur-3xl p-9 rounded-2xl grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              > 
            <Link to="/contact-us" className="inline">Let's Talk

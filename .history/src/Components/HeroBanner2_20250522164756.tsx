...
const HeroBanner2: React.FC = () => {
  ...
  return (
    ...
    <section className="relative w-full h-[85vh] overflow-hidden">
     ...
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 md:gap-20 lg:gap-24 p-6 sm:p-8 md:p-10 lg:p-12">
  {/* Left Side - Text Content */}
  <motion.div 
    className="flex flex-col justify-center space-y-8 sm:space-y-10 text-left"

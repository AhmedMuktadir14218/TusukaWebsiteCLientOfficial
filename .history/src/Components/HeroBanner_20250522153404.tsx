...
<video width="1350px" autoplay="" muted="" loop="" id="myVideo" style="margin-bottom: -160px; margin-top: -180px;" controls="">
          <source src="https://www.tusuka.com/wp-content/themes/tusuka2/video/TusukaBanner.mp4" type="video/mp4" />
	    </video>
      {/* Banner Content Area */}
      <div className="absolute inset-0 flex items-center justify-center z-10 px-4 sm:px-8">
        <div className="relative max-w-[950px] w-full text-center pb-28 sm:pb-16">

...
import logo9 from 'https://files.brandlogos.net/svg/OeSUpbYXG3/h&m-logo-brandlogos.net_kn1b67q9c.svg';
...
const LogoMoving: React.FC = () => {
  return (
    <section className="w-full h-[15vh] bg-white py-12 overflow-hidden relative">

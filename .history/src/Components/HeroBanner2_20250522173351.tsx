...
const HeroBanner2: React.FC = () => {
  ...
  return (
    ...
    <section className="relative  w-full h-[85vh] overflow-hidden">
      ...
      <div className=" container mx-auto px-4 absolute inset-0 flex items-center justify-start z-10 px-4 sm:px-8">
        <div className=" bg-transparent    p-9 rounded-2xl grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 md:gap-20 lg:gap-24   w-full max-w-6xl mx-auto">

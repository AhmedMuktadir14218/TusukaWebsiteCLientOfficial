    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <AnimatePresence initial={false} custom={currentImageIndex}>
        <motion.img
          ...
          className="absolute inset-0 w-full h-full object-cover object-center z-0 opacity-100 blur-[2px] brightness-90"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10 px-4 sm:px-8">
        <div className="relative max-w-[950px] w-full text-center pb-28 sm:pb-16">
         ...
         <div
  className="absolute inset-x-0 top-0 bottom-0 bg-[#E32E2E] -z-10 lg:h-120 md:h-80 sm:h-70  opacity-50"
  style={{
